...
val calcularSalario: (Int, Double) -> Double = { horasTrabalhadas, valorPorHora ->
  ...
  //    // Implemente a expressão lambda para calcular o salário com base nas horas trabalhadas e
  // valor por hora
...
fun main() {
  ...
  ) // Esperado: "Produto: Caneta, Preço: 1.5, Quantidade: 10"
  ...
  println("Números positivos: ${filtrarNumerosPositivos(listOf(-1, 2, 3, -4)) { it > 0 }}") //
  // Esperado: [2, 3]
